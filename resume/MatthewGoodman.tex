...
\address{{\bf Home} \\ Mission Distric \\ San Francisco, CA 94110 \\ meawoppl@gmail.com \\ \href{https://meawoppl.github.io}{meawoppl.github.io}}

\address{{\bf Work} \\ 951 Hudson Ave \\ San Francisco, CA 94124 \\ (415) 234-3549 \\ matt@exclosure.io}
...
\begin{itemize}  \itemsep -2pt
  ...
  \item Accepted into TAP Lab and Catalyst accelerator programs funded by Space Force
\end{itemize}
...
\section{Languages and Tools}
 \begin{tabular}{l p{5.5in}}
   ...
   \underline{Rusty at:}     & Typescript/Javascript, Vue, Docker, ansible, C++, LLVM-IR, CUDA, C\# \\
   \underline{Used in prod:} & Japanese, FORTRAN, qBasic, php, sql, RoR, bash, Meteor, Scala \\
   \underline{Played with:}  & Verilog, Golang, Kotlin, Electron, React Native, Unity
 \end{tabular}

\section{Miscellaneous}
  \begin{tabular}{l p{5.5in}}
    \underline{OSS Contributions:} & cPython, numba, scipy, pycuda, datadog, ecto, openCV, pandas, \\
                                   & smile, emscripten, progressbar  \\
