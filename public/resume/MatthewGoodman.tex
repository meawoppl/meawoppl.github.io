...
% Keep every section heading on the same page as the start of its content
...
\address{{\bf Home} \\ Mission District \\ San Francisco, CA 94110 \\ \includegraphics[scale=1.5]{email-address.png} \\ \href{https://meawoppl.github.io/portfolio}{Art Portfolio}  \\ Signal: mattyg.01}
...
{\bf Engineering Lead,} \href{https://www.cosmicfrontier.org}{Cosmic Frontier Labs}, a \href{https://www.renaissancephilanthropy.org}{Renaissance Philanthropy} program \hfill
2025 -- Present
\begin{itemize}  \itemsep -2pt
  \item Help lead a team of $\sim$30 building a fleet of modular, rapidly iterated space telescopes.
  \item \textbf{Sourced the philanthropic funding} behind the program.
  \item Architected the Rust \textbf{fine guidance and star tracking stack}, steering a fast mirror from Jetson Orin.
  \item Built the telescope test bench: sensor and actuator drivers, calibration, and piezo jitter injection.
  \item Wrote \href{https://github.com/CosmicFrontierLabs/focalplane}{focalplane}, an \textbf{end-to-end imaging simulator} from star catalog to detector.
\end{itemize}

{\bf Creator \& Lead Developer,} \href{https://github.com/OrbitalCommons}{Orbital Commons} \hfill
2025 -- Present
\begin{itemize}  \itemsep -2pt
  \item \textbf{Sourced the philanthropic funding} for the project.
  \item \textbf{Open-source Rust tools} for satellite imaging and navigation; 11,000+ downloads.
  \item \href{https://github.com/OrbitalCommons/zodiacal}{zodiacal}: \textbf{blind plate solver}, solves 98.5\% of 1,000 test fields, median 1.07\,s.
  \item Also \href{https://github.com/OrbitalCommons/starfield}{starfield} (catalogs, ephemerides), \href{https://github.com/OrbitalCommons/fitsio-pure}{fitsio-pure} (pure-Rust FITS), and \href{https://github.com/OrbitalCommons/rizzma}{rizzma} (plotting).
\end{itemize}
